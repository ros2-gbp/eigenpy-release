## eigenpy (humble) - 3.13.0-1

The packages in the `eigenpy` repository were released into the `humble` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r humble eigenpy` on `Fri, 05 Jun 2026 15:41:01 -0000`
...
## eigenpy (jazzy) - 3.13.0-1

The packages in the `eigenpy` repository were released into the `jazzy` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r jazzy eigenpy` on `Fri, 05 Jun 2026 15:38:57 -0000`
...
- upstream repository: https://github.com/stack-of-tasks/eigenpy.git
- release repository: https://github.com/ros2-gbp/eigenpy-release.git
- rosdistro version: `3.12.0-3`
- old version: `3.12.0-3`
- new version: `3.13.0-1`
...
## eigenpy (rolling) - 3.13.0-1

The packages in the `eigenpy` repository were released into the `rolling` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r rolling eigenpy` on `Fri, 05 Jun 2026 15:33:39 -0000`
...
- upstream repository: https://github.com/stack-of-tasks/eigenpy.git
- release repository: https://github.com/ros2-gbp/eigenpy-release.git
- rosdistro version: `3.12.0-2`
- old version: `3.12.0-2`
- new version: `3.13.0-1`
...
## eigenpy (rolling) - 3.12.0-1

The packages in the `eigenpy` repository were released into the `rolling` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r rolling eigenpy` on `Tue, 14 Oct 2025 14:01:50 -0000`
...
## eigenpy (kilted) - 3.12.0-1

The packages in the `eigenpy` repository were released into the `kilted` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r kilted eigenpy` on `Tue, 14 Oct 2025 13:57:50 -0000`
...
## eigenpy (jazzy) - 3.12.0-1

The packages in the `eigenpy` repository were released into the `jazzy` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy eigenpy` on `Tue, 14 Oct 2025 13:54:29 -0000`
...
## eigenpy (humble) - 3.12.0-1

The packages in the `eigenpy` repository were released into the `humble` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r humble eigenpy` on `Tue, 14 Oct 2025 13:50:45 -0000`
...
## eigenpy (humble) - 3.11.0-2

The packages in the `eigenpy` repository were released into the `humble` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r humble eigenpy` on `Tue, 14 Oct 2025 13:44:32 -0000`
...
## eigenpy (kilted) - 3.11.0-1

The packages in the `eigenpy` repository were released into the `kilted` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r kilted eigenpy` on `Mon, 23 Jun 2025 06:10:17 -0000`
...
## eigenpy (rolling) - 3.11.0-1

The packages in the `eigenpy` repository were released into the `rolling` distro by running `/nix/store/fzk45mxsx3ihl63w4mhvkzhdb4hj8jy1-python3.12-bloom-0.12.0/bin/bloom-release -r rolling eigenpy` on `Fri, 25 Apr 2025 15:26:52 -0000`
...
The packages in the `eigenpy` repository were released into the `jazzy` distro by running `/nix/store/fzk45mxsx3ihl63w4mhvkzhdb4hj8jy1-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy eigenpy` on `Fri, 25 Apr 2025 15:17:55 -0000`
